                                ...
                                listItemComponents: [
                                    ListItemComponent {
                                        ...
                                        Container {
                                            id: itemRoot
                                            minWidth: ui.du(30)
                                            background: (itemRoot.ListItem.selected || itemRoot.ListItem.active) ? ui.palette.primarySoft : SystemDefaults.Paints.ContainerBackground //preferredWidth: ui.du(85.3) //preferredHeight: ui.du(10) //maxHeight: ui.du(15)
                                            layout: StackLayout {
                                ...
                                listItemComponents: [
                                    ListItemComponent {
                                        ...
                                        Container {
                                            ...
                                            background: (_itemRoot.ListItem.active || _itemRoot.ListItem.selected) ? ui.palette.primarySoft : SystemDefaults.Paints.ContainerBackground
                                            layout: StackLayout {
